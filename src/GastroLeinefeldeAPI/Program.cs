...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "API for importing and retrieving menus from essen-auf-raedern-eichsfeld.de"
    });
});
...
builder.Services.AddHttpClient<IWebsiteClient, WebsiteClient>(client =>
{
    ...
    client.DefaultRequestHeaders.UserAgent.ParseAdd("GastroMenuParserAPI/1.0 (+https://gastro.opik.net)");
});
